...
<Notebook>
  ...
  <NotebookPage label="Automating Infrastructure">
    ...
    In most cases, you can model the problem domain using data structures and write a [reproducible program](https://robsteranium.github.io/functional-reproducibility/) that automates the task at hand. Let's pretend Python classes are immutable for the purpose of demonstration:
