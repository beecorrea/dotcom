...
<Notebook>
  ...
  <NotebookPage label="Automating Infrastructure">
    ...
    The next step is converting this program into a mature capability that can be used as a service by application owners. This is a big step that will lead you to Platform Engineering, where Product meets Infrastructure.
  </NotebookPage>
