...
import capote from './images/rua_capote_valente_39_2023.jpeg'
import pasteur from './images/av_pasteur_138_2019.jpg'
...
<Tabs>
  <Tab label="IBM">
    ...
    <NoteImage image={pasteur} caption="View from the IBM office, circa 2019." />
    ...
    Together, we helped save 10,000+ hours of manual work each year in just 5 countries. We then went on to expand this solution across all continents where IGF operates.
  ...
  <Tab label="Nubank">
    ...
    <NoteImage image={capote} caption="Data BU folks during our yearly onsite in HQ1, circa 2023" />
    ...
    * App usage metrics and even Prometheus metrics.
