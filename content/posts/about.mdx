...
<CareerTabs>
  ...
  <TabPanel label="Nubank">
    ...
    * App usage metrics, Jira metrics, and even Prometheus metrics.
    ...
    If you read everything until here, you probably already know what happened on November 2025 😆. Working on Multi-Repos raised my skills to a completely different level: software engineering, problem solving, leadership, culture, engineering management, decision making and so many other skills. I met world class engineers and industry leaders that completely shifted my understanding of building companies. I also made many friends there that I love and care and am still close to this day ❤️.
